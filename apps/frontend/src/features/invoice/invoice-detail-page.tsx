        ...
        {invoice && (
          <div className='space-y-6'>
            <div className='flex flex-wrap items-start justify-between gap-3'>
              <div>
                <h2 data-testid='detail-invoice-number' className='text-2xl font-bold tracking-tight text-foreground'>
                  ...
                  <TableBody>
                    {invoice.items.map((item) => (
                      <TableRow key={item.id} className='hover:bg-transparent'>
                        ...
                        <TableCell className='px-0 text-right tabular-nums text-foreground/80'>
                          {item.quantity}
                        </TableCell>
                        <TableCell className='px-0 text-right tabular-nums text-foreground/80'>
                          {money(item.rate)}
